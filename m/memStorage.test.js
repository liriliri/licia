it('get and set items', function ()
{
    ...
    memStorage.setItem('test', 'eris');
    expect(memStorage.getItem('test')).to.equal('eris');
...
{
    memStorage.setItem('test2', 'eris');
    expect(JSON.parse(JSON.stringify(memStorage))).to.eql({test2: 'eris', test: 'eris'});
});
